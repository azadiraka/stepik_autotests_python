...
class ProductPage(BasePage):
    ...
    def compare_books_name_in_basket_and_in_catalogue(self, book_name):
    ...
    def compare_price_in_basket_and_in_catalogue(self, book_price):
    ...
    def success_message_should_dissapeared(self):
